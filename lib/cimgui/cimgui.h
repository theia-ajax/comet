...
// https://github.com/cimgui/cimgui based on imgui.h file version "1.89.5" 18950
...
typedef void (
	*ImDrawCallback)(const ImDrawList* parent_list, const ImDrawCmd* cmd);
struct ImDrawCmd {
	ImVec4 ClipRect;
...
typedef void (
	*ImGuiContextHookCallback)(ImGuiContext* ctx, ImGuiContextHook* hook);
typedef enum {
...
CIMGUI_API void igSetNextWindowPos(
	const ImVec2 pos,
	ImGuiCond cond,
	const ImVec2 pivot);
...
CIMGUI_API void igSetWindowPos_Str(
	const char* name,
	const ImVec2 pos,
	ImGuiCond cond);
CIMGUI_API void igSetWindowSize_Str(
	const char* name,
	const ImVec2 size,
	ImGuiCond cond);
CIMGUI_API void igSetWindowCollapsed_Str(
	const char* name,
	bool collapsed,
	ImGuiCond cond);
...
CIMGUI_API void igPushID_StrStr(
...
CIMGUI_API ImGuiID
igGetID_StrStr(const char* str_id_begin, const char* str_id_end);
...
CIMGUI_API bool igCombo_Str(
	...
	int popup_max_height_in_items);
CIMGUI_API bool igCombo_FnBoolPtr(
	const char* label,
	int* current_item,
...
CIMGUI_API bool igInputFloat(
	...
	const char* format,
	ImGuiInputTextFlags flags);
CIMGUI_API bool igInputFloat2(
	const char* label,
	float v[2],
	const char* format,
	ImGuiInputTextFlags flags);
CIMGUI_API bool igInputFloat3(
	const char* label,
	float v[3],
	const char* format,
	ImGuiInputTextFlags flags);
CIMGUI_API bool igInputFloat4(
	const char* label,
	float v[4],
	const char* format,
	ImGuiInputTextFlags flags);
CIMGUI_API bool igInputInt(
	...
	int step_fast,
	ImGuiInputTextFlags flags);
CIMGUI_API bool igInputInt2(
	const char* label,
	int v[2],
	ImGuiInputTextFlags flags);
CIMGUI_API bool igInputInt3(
	const char* label,
	int v[3],
	ImGuiInputTextFlags flags);
CIMGUI_API bool igInputInt4(
	const char* label,
	int v[4],
	ImGuiInputTextFlags flags);
...
CIMGUI_API bool igInputScalarN(
	...
	const char* format,
	ImGuiInputTextFlags flags);
CIMGUI_API bool igColorEdit3(
	const char* label,
	float col[3],
	ImGuiColorEditFlags flags);
CIMGUI_API bool igColorEdit4(
	const char* label,
	float col[4],
	ImGuiColorEditFlags flags);
CIMGUI_API bool igColorPicker3(
	const char* label,
	float col[3],
	ImGuiColorEditFlags flags);
CIMGUI_API bool igColorPicker4(
	const char* label,
	float col[4],
	ImGuiColorEditFlags flags,
	const float* ref_col);
CIMGUI_API bool igColorButton(
	const char* desc_id,
	const ImVec4 col,
	ImGuiColorEditFlags flags,
	const ImVec2 size);
...
CIMGUI_API bool igTreeNodeV_Str(
	const char* str_id,
	const char* fmt,
	va_list args);
CIMGUI_API bool igTreeNodeV_Ptr(
	const void* ptr_id,
	const char* fmt,
	va_list args);
CIMGUI_API bool igTreeNodeEx_Str(const char* label, ImGuiTreeNodeFlags flags);
CIMGUI_API bool igTreeNodeEx_StrStr(
	const char* str_id,
	ImGuiTreeNodeFlags flags,
	const char* fmt,
	...);
CIMGUI_API bool igTreeNodeEx_Ptr(
	const void* ptr_id,
	ImGuiTreeNodeFlags flags,
	const char* fmt,
	...);
CIMGUI_API bool igTreeNodeExV_Str(
	const char* str_id,
	ImGuiTreeNodeFlags flags,
	const char* fmt,
	va_list args);
CIMGUI_API bool igTreeNodeExV_Ptr(
	const void* ptr_id,
	ImGuiTreeNodeFlags flags,
	const char* fmt,
	va_list args);
...
CIMGUI_API bool igCollapsingHeader_TreeNodeFlags(
	const char* label,
	ImGuiTreeNodeFlags flags);
CIMGUI_API bool igCollapsingHeader_BoolPtr(
	const char* label,
	bool* p_visible,
	ImGuiTreeNodeFlags flags);
CIMGUI_API void igSetNextItemOpen(bool is_open, ImGuiCond cond);
CIMGUI_API bool igSelectable_Bool(
	const char* label,
	bool selected,
...
CIMGUI_API bool igListBox_Str_arr(
	...
	int items_count,
	int height_in_items);
CIMGUI_API bool igListBox_FnBoolPtr(
	const char* label,
	int* current_item,
	bool (*items_getter)(void* data, int idx, const char** out_text),
	void* data,
...
CIMGUI_API bool igMenuItem_Bool(
	const char* label,
	const char* shortcut,
	bool selected,
	bool enabled);
CIMGUI_API bool igMenuItem_BoolPtr(
	const char* label,
	const char* shortcut,
	bool* p_selected,
	bool enabled);
...
CIMGUI_API bool igBeginPopupModal(
	const char* name,
	bool* p_open,
	ImGuiWindowFlags flags);
CIMGUI_API void igEndPopup(void);
CIMGUI_API void igOpenPopup_Str(
	const char* str_id,
	ImGuiPopupFlags popup_flags);
CIMGUI_API void igOpenPopup_ID(ImGuiID id, ImGuiPopupFlags popup_flags);
CIMGUI_API void igOpenPopupOnItemClick(
	const char* str_id,
	ImGuiPopupFlags popup_flags);
CIMGUI_API void igCloseCurrentPopup(void);
CIMGUI_API bool igBeginPopupContextItem(
	const char* str_id,
	ImGuiPopupFlags popup_flags);
CIMGUI_API bool igBeginPopupContextWindow(
	const char* str_id,
	ImGuiPopupFlags popup_flags);
CIMGUI_API bool igBeginPopupContextVoid(
	const char* str_id,
	ImGuiPopupFlags popup_flags);
...
CIMGUI_API void igTableNextRow(
...
CIMGUI_API void igTableSetBgColor(
...
CIMGUI_API bool igBeginTabItem(
	const char* label,
	bool* p_open,
	ImGuiTabItemFlags flags);
...
CIMGUI_API bool igSetDragDropPayload(
	const char* type,
	const void* data,
	size_t sz,
	ImGuiCond cond);
...
CIMGUI_API bool igIsRectVisible_Vec2(
...
CIMGUI_API bool igBeginChildFrame(
	ImGuiID id,
	const ImVec2 size,
	ImGuiWindowFlags flags);
...
CIMGUI_API int igGetKeyPressedAmount(
	ImGuiKey key,
	float repeat_delay,
	float rate);
...
CIMGUI_API bool igIsMouseHoveringRect(
	const ImVec2 r_min,
	const ImVec2 r_max,
	bool clip);
...
CIMGUI_API bool igIsMouseDragging(
	ImGuiMouseButton button,
	float lock_threshold);
CIMGUI_API void igGetMouseDragDelta(
	ImVec2* pOut,
	ImGuiMouseButton button,
	float lock_threshold);
...
CIMGUI_API void igLoadIniSettingsFromMemory(
	const char* ini_data,
	size_t ini_size);
...
CIMGUI_API bool igDebugCheckVersionAndDataLayout(
	...
	size_t sz_drawvert,
	size_t sz_drawidx);
CIMGUI_API void igSetAllocatorFunctions(
...
CIMGUI_API ImGuiTextRange* ImGuiTextRange_ImGuiTextRange_Str(
	const char* _b,
	const char* _e);
CIMGUI_API bool ImGuiTextRange_empty(ImGuiTextRange* self);
CIMGUI_API void ImGuiTextRange_split(
	ImGuiTextRange* self,
	char separator,
...
CIMGUI_API void ImGuiTextBuffer_appendfv(
	...
	const char* fmt,
	va_list args);
CIMGUI_API ImGuiStoragePair* ImGuiStoragePair_ImGuiStoragePair_Int(
	ImGuiID _key,
	int _val_i);
...
CIMGUI_API ImGuiStoragePair* ImGuiStoragePair_ImGuiStoragePair_Float(
	ImGuiID _key,
	float _val_f);
CIMGUI_API ImGuiStoragePair* ImGuiStoragePair_ImGuiStoragePair_Ptr(
	ImGuiID _key,
	void* _val_p);
...
CIMGUI_API float ImGuiStorage_GetFloat(
	...
	ImGuiID key,
	float default_val);
CIMGUI_API void ImGuiStorage_SetFloat(
	ImGuiStorage* self,
	ImGuiID key,
	float val);
CIMGUI_API void* ImGuiStorage_GetVoidPtr(ImGuiStorage* self, ImGuiID key);
CIMGUI_API void ImGuiStorage_SetVoidPtr(
	ImGuiStorage* self,
	ImGuiID key,
	void* val);
...
CIMGUI_API void ImDrawListSplitter_Split(
	...
	int count);
CIMGUI_API void ImDrawListSplitter_Merge(
	ImDrawListSplitter* self,
	ImDrawList* draw_list);
...
CIMGUI_API void ImDrawList_PushTextureID(
	ImDrawList* self,
...
CIMGUI_API void ImDrawList_PathLineToMergeDuplicate(
	ImDrawList* self,
	const ImVec2 pos);
...
CIMGUI_API void ImDrawList_PrimReserve(
	ImDrawList* self,
	int idx_count,
	int vtx_count);
...
CIMGUI_API ImFont* ImFontAtlas_AddFont(
	ImFontAtlas* self,
...
CIMGUI_API const ImWchar* ImFontAtlas_GetGlyphRangesVietnamese(
	ImFontAtlas* self);
CIMGUI_API int ImFontAtlas_AddCustomRectRegular(
	ImFontAtlas* self,
	int width,
	int height);
...
CIMGUI_API const ImFontGlyph* ImFont_FindGlyphNoFallback(
	ImFont* self,
	ImWchar c);
...
CIMGUI_API ImGuiID
igImHashData(const void* data, size_t data_size, ImGuiID seed);
CIMGUI_API ImGuiID
igImHashStr(const char* data, size_t data_size, ImGuiID seed);
...
CIMGUI_API int igImFormatString(
	char* buf,
	size_t buf_size,
	const char* fmt,
	...);
CIMGUI_API int igImFormatStringV(
	char* buf,
	size_t buf_size,
	const char* fmt,
	va_list args);
CIMGUI_API void igImFormatStringToTempBuffer(
	const char** out_buf,
...
CIMGUI_API const char* igImParseFormatTrimDecorations(
	const char* format,
	char* buf,
	size_t buf_size);
CIMGUI_API void igImParseFormatSanitizeForPrinting(
	const char* fmt_in,
	char* fmt_out,
	size_t fmt_out_size);
CIMGUI_API const char* igImParseFormatSanitizeForScanning(
	const char* fmt_in,
	char* fmt_out,
	size_t fmt_out_size);
...
CIMGUI_API int igImTextStrToUtf8(
	char* out_buf,
	int out_buf_size,
	const ImWchar* in_text,
	const ImWchar* in_text_end);
CIMGUI_API int igImTextCharFromUtf8(
...
CIMGUI_API int igImTextCountCharsFromUtf8(
	const char* in_text,
	const char* in_text_end);
CIMGUI_API int igImTextCountUtf8BytesFromChar(
	const char* in_text,
	const char* in_text_end);
CIMGUI_API int igImTextCountUtf8BytesFromStr(
	const ImWchar* in_text,
	const ImWchar* in_text_end);
...
CIMGUI_API ImU64
igImFileRead(void* data, ImU64 size, ImU64 count, ImFileHandle file);
CIMGUI_API ImU64
igImFileWrite(const void* data, ImU64 size, ImU64 count, ImFileHandle file);
CIMGUI_API void* igImFileLoadToMemory(
	const char* filename,
	const char* mode,
...
CIMGUI_API void igImClamp(
	ImVec2* pOut,
	const ImVec2 v,
	const ImVec2 mn,
	ImVec2 mx);
CIMGUI_API void igImLerp_Vec2Float(
	ImVec2* pOut,
	const ImVec2 a,
	const ImVec2 b,
	float t);
CIMGUI_API void igImLerp_Vec2Vec2(
	ImVec2* pOut,
	const ImVec2 a,
	const ImVec2 b,
	const ImVec2 t);
CIMGUI_API void igImLerp_Vec4(
	ImVec4* pOut,
	const ImVec4 a,
	const ImVec4 b,
	float t);
...
CIMGUI_API void igImBezierCubicClosestPointCasteljau(
	...
	const ImVec2 p,
	float tess_tol);
CIMGUI_API void igImBezierQuadraticCalc(
	ImVec2* pOut,
	const ImVec2 p1,
	const ImVec2 p2,
	const ImVec2 p3,
	float t);
CIMGUI_API void igImLineClosestPoint(
	ImVec2* pOut,
	const ImVec2 a,
	const ImVec2 b,
	const ImVec2 p);
CIMGUI_API bool igImTriangleContainsPoint(
	const ImVec2 a,
	const ImVec2 b,
	const ImVec2 c,
	const ImVec2 p);
CIMGUI_API void igImTriangleClosestPoint(
	ImVec2* pOut,
	const ImVec2 a,
	const ImVec2 b,
	const ImVec2 c,
...
CIMGUI_API void igImTriangleBarycentricCoords(
	...
	float* out_v,
	float* out_w);
CIMGUI_API float igImTriangleArea(
	const ImVec2 a,
	const ImVec2 b,
	const ImVec2 c);
...
CIMGUI_API const char* ImGuiTextIndex_get_line_begin(
	ImGuiTextIndex* self,
	const char* base,
	int n);
CIMGUI_API const char* ImGuiTextIndex_get_line_end(
	ImGuiTextIndex* self,
	const char* base,
	int n);
CIMGUI_API void ImGuiTextIndex_append(
	ImGuiTextIndex* self,
	const char* base,
	int old_size,
	int new_size);
...
CIMGUI_API void ImDrawDataBuilder_FlattenIntoSingleLayer(
	ImDrawDataBuilder* self);
CIMGUI_API void* ImGuiDataVarInfo_GetVarPtr(
	ImGuiDataVarInfo* self,
	void* parent);
CIMGUI_API ImGuiStyleMod* ImGuiStyleMod_ImGuiStyleMod_Int(
	ImGuiStyleVar idx,
	int v);
CIMGUI_API void ImGuiStyleMod_destroy(ImGuiStyleMod* self);
CIMGUI_API ImGuiStyleMod* ImGuiStyleMod_ImGuiStyleMod_Float(
	ImGuiStyleVar idx,
	float v);
CIMGUI_API ImGuiStyleMod* ImGuiStyleMod_ImGuiStyleMod_Vec2(
	ImGuiStyleVar idx,
	ImVec2 v);
...
CIMGUI_API void ImGuiMenuColumns_Update(
...
CIMGUI_API float ImGuiMenuColumns_DeclColumns(
	...
	float w_shortcut,
	float w_mark);
CIMGUI_API void ImGuiMenuColumns_CalcNextTotalWidth(
	ImGuiMenuColumns* self,
	bool update_offsets);
...
CIMGUI_API void ImGuiInputTextState_OnKeyPressed(
...
CIMGUI_API void ImGuiStackSizes_SetToContextState(
	ImGuiStackSizes* self,
	ImGuiContext* ctx);
CIMGUI_API void ImGuiStackSizes_CompareWithContextState(
	ImGuiStackSizes* self,
	ImGuiContext* ctx);
...
ImGuiListClipperRange_FromIndices(int min, int max);
...
CIMGUI_API void ImGuiListClipperData_Reset(
	ImGuiListClipperData* self,
...
CIMGUI_API void ImGuiViewportP_CalcWorkRectPos(
	ImVec2* pOut,
	ImGuiViewportP* self,
...
CIMGUI_API void ImGuiViewportP_GetBuildWorkRect(
	ImRect* pOut,
	ImGuiViewportP* self);
...
CIMGUI_API ImGuiWindow* ImGuiWindow_ImGuiWindow(
	ImGuiContext* context,
	const char* name);
CIMGUI_API void ImGuiWindow_destroy(ImGuiWindow* self);
CIMGUI_API ImGuiID
ImGuiWindow_GetID_Str(ImGuiWindow* self, const char* str, const char* str_end);
...
CIMGUI_API ImGuiID
ImGuiWindow_GetIDFromRectangle(ImGuiWindow* self, const ImRect r_abs);
...
CIMGUI_API bool igIsWindowWithinBeginStackOf(
	ImGuiWindow* window,
	ImGuiWindow* potential_parent);
CIMGUI_API bool igIsWindowAbove(
	ImGuiWindow* potential_above,
	ImGuiWindow* potential_below);
CIMGUI_API bool igIsWindowNavFocusable(ImGuiWindow* window);
CIMGUI_API void igSetWindowPos_WindowPtr(
	ImGuiWindow* window,
	const ImVec2 pos,
	ImGuiCond cond);
CIMGUI_API void igSetWindowSize_WindowPtr(
	ImGuiWindow* window,
	const ImVec2 size,
	ImGuiCond cond);
CIMGUI_API void igSetWindowCollapsed_WindowPtr(
	ImGuiWindow* window,
	bool collapsed,
	ImGuiCond cond);
CIMGUI_API void igSetWindowHitTestHole(
	ImGuiWindow* window,
	const ImVec2 pos,
	const ImVec2 size);
CIMGUI_API void igSetWindowHiddendAndSkipItemsForCurrentFrame(
	ImGuiWindow* window);
CIMGUI_API void igWindowRectAbsToRel(
	ImRect* pOut,
	ImGuiWindow* window,
	const ImRect r);
CIMGUI_API void igWindowRectRelToAbs(
	ImRect* pOut,
	ImGuiWindow* window,
	const ImRect r);
...
CIMGUI_API void igBringWindowToDisplayBehind(
	ImGuiWindow* window,
...
CIMGUI_API ImGuiID
igAddContextHook(ImGuiContext* context, const ImGuiContextHook* hook);
CIMGUI_API void igRemoveContextHook(
	ImGuiContext* context,
	ImGuiID hook_to_remove);
CIMGUI_API void igCallContextHooks(
	ImGuiContext* context,
	ImGuiContextHookType type);
CIMGUI_API void igSetWindowViewport(
	ImGuiWindow* window,
	ImGuiViewportP* viewport);
...
CIMGUI_API void igLocalizeRegisterEntries(
...
CIMGUI_API void igSetScrollFromPosX_WindowPtr(
	ImGuiWindow* window,
	float local_x,
	float center_x_ratio);
CIMGUI_API void igSetScrollFromPosY_WindowPtr(
	ImGuiWindow* window,
	float local_y,
	float center_y_ratio);
CIMGUI_API void igScrollToItem(ImGuiScrollFlags flags);
CIMGUI_API void igScrollToRect(
	ImGuiWindow* window,
	const ImRect rect,
	ImGuiScrollFlags flags);
CIMGUI_API void igScrollToRectEx(
	ImVec2* pOut,
	ImGuiWindow* window,
	const ImRect rect,
	ImGuiScrollFlags flags);
CIMGUI_API void igScrollToBringRectIntoView(
	ImGuiWindow* window,
	const ImRect rect);
...
CIMGUI_API ImGuiID igGetIDWithSeed_Str(
	const char* str_id_begin,
	const char* str_id_end,
	ImGuiID seed);
...
CIMGUI_API void igCalcItemSize(
	ImVec2* pOut,
	ImVec2 size,
	float default_w,
	float default_h);
...
CIMGUI_API void igShrinkWidths(
...
CIMGUI_API void igLogRenderedText(
...
CIMGUI_API void igClosePopupToLevel(
	int remaining,
...
CIMGUI_API bool igBeginTooltipEx(
...
CIMGUI_API bool igMenuItemEx(
	...
	bool selected,
	bool enabled);
CIMGUI_API bool igBeginComboPopup(
	ImGuiID popup_id,
	const ImRect bb,
	ImGuiComboFlags flags);
...
CIMGUI_API ImGuiKey
igConvertSingleModFlagToKey(ImGuiContext* ctx, ImGuiKey key);
CIMGUI_API ImGuiKeyData* igGetKeyData_ContextPtr(
	ImGuiContext* ctx,
	ImGuiKey key);
CIMGUI_API ImGuiKeyData* igGetKeyData_Key(ImGuiKey key);
CIMGUI_API void igGetKeyChordName(
	ImGuiKeyChord key_chord,
	char* out_buf,
	int out_buf_size);
CIMGUI_API ImGuiKey igMouseButtonToKey(ImGuiMouseButton button);
CIMGUI_API bool igIsMouseDragPastThreshold(
	ImGuiMouseButton button,
	float lock_threshold);
...
CIMGUI_API int igCalcTypematicRepeatAmount(
	float t0,
	float t1,
	float repeat_delay,
	float repeat_rate);
CIMGUI_API void igGetTypematicRepeatRate(
...
CIMGUI_API void igSetKeyOwner(
	ImGuiKey key,
	ImGuiID owner_id,
	ImGuiInputFlags flags);
CIMGUI_API void igSetKeyOwnersForKeyChord(
	ImGuiKeyChord key,
	ImGuiID owner_id,
	ImGuiInputFlags flags);
...
CIMGUI_API ImGuiKeyOwnerData* igGetKeyOwnerData(
	ImGuiContext* ctx,
	ImGuiKey key);
CIMGUI_API bool igIsKeyDown_ID(ImGuiKey key, ImGuiID owner_id);
CIMGUI_API bool igIsKeyPressed_ID(
	ImGuiKey key,
	ImGuiID owner_id,
	ImGuiInputFlags flags);
...
CIMGUI_API bool igIsMouseClicked_ID(
	ImGuiMouseButton button,
	ImGuiID owner_id,
	ImGuiInputFlags flags);
CIMGUI_API bool igIsMouseReleased_ID(ImGuiMouseButton button, ImGuiID owner_id);
CIMGUI_API bool igShortcut(
	ImGuiKeyChord key_chord,
	ImGuiID owner_id,
	ImGuiInputFlags flags);
CIMGUI_API bool igSetShortcutRouting(
	ImGuiKeyChord key_chord,
	ImGuiID owner_id,
	ImGuiInputFlags flags);
CIMGUI_API bool igTestShortcutRouting(
	ImGuiKeyChord key_chord,
	ImGuiID owner_id);
...
CIMGUI_API void igSetWindowClipRectBeforeSetChannel(
	ImGuiWindow* window,
	const ImRect clip_rect);
CIMGUI_API void igBeginColumns(
	const char* str_id,
	int count,
	ImGuiOldColumnFlags flags);
...
CIMGUI_API ImGuiOldColumns* igFindOrCreateColumns(
	ImGuiWindow* window,
	ImGuiID id);
CIMGUI_API float igGetColumnOffsetFromNorm(
	const ImGuiOldColumns* columns,
	float offset_norm);
CIMGUI_API float igGetColumnNormFromOffset(
	const ImGuiOldColumns* columns,
	float offset);
...
CIMGUI_API ImGuiTableInstanceData* igTableGetInstanceData(
	ImGuiTable* table,
	int instance_no);
...
CIMGUI_API void igTableFixColumnSortDirection(
	ImGuiTable* table,
	ImGuiTableColumn* column);
CIMGUI_API float igTableGetColumnWidthAuto(
	ImGuiTable* table,
	ImGuiTableColumn* column);
...
CIMGUI_API void igTableGetCellBgRect(
	ImRect* pOut,
	const ImGuiTable* table,
	int column_n);
CIMGUI_API const char* igTableGetColumnName_TablePtr(
	const ImGuiTable* table,
	int column_n);
CIMGUI_API ImGuiID
igTableGetColumnResizeID(ImGuiTable* table, int column_n, int instance_no);
CIMGUI_API float igTableGetMaxColumnWidth(
	const ImGuiTable* table,
	int column_n);
...
CIMGUI_API ImGuiTableSettings* igTableSettingsCreate(
	ImGuiID id,
	int columns_count);
CIMGUI_API ImGuiTableSettings* igTableSettingsFindByID(ImGuiID id);
CIMGUI_API ImGuiTabBar* igGetCurrentTabBar(void);
CIMGUI_API bool igBeginTabBarEx(
	ImGuiTabBar* tab_bar,
	const ImRect bb,
	ImGuiTabBarFlags flags);
CIMGUI_API ImGuiTabItem* igTabBarFindTabByID(
	ImGuiTabBar* tab_bar,
	ImGuiID tab_id);
CIMGUI_API ImGuiTabItem* igTabBarFindTabByOrder(
	ImGuiTabBar* tab_bar,
	int order);
...
CIMGUI_API const char* igTabBarGetTabName(
	ImGuiTabBar* tab_bar,
	ImGuiTabItem* tab);
...
CIMGUI_API void igTabBarQueueReorder(
	ImGuiTabBar* tab_bar,
	ImGuiTabItem* tab,
	int offset);
CIMGUI_API void igTabBarQueueReorderFromMousePos(
	ImGuiTabBar* tab_bar,
	ImGuiTabItem* tab,
	ImVec2 mouse_pos);
...
CIMGUI_API void igRenderText(
	ImVec2 pos,
	const char* text,
	const char* text_end,
	bool hide_text_after_hash);
CIMGUI_API void igRenderTextWrapped(
	ImVec2 pos,
	const char* text,
	const char* text_end,
	float wrap_width);
...
CIMGUI_API void igRenderColorRectWithAlphaCheckerboard(
	...
	float rounding,
	ImDrawFlags flags);
CIMGUI_API void igRenderNavHighlight(
	const ImRect bb,
	ImGuiID id,
	ImGuiNavHighlightFlags flags);
CIMGUI_API const char* igFindRenderedTextEnd(
	const char* text,
	const char* text_end);
...
CIMGUI_API void igRenderCheckMark(
	ImDrawList* draw_list,
	ImVec2 pos,
	ImU32 col,
	float sz);
...
CIMGUI_API void igRenderRectFilledWithHole(
	...
	ImU32 col,
	float rounding);
CIMGUI_API void igTextEx(
	const char* text,
	const char* text_end,
	ImGuiTextFlags flags);
CIMGUI_API bool igButtonEx(
	const char* label,
	const ImVec2 size_arg,
	ImGuiButtonFlags flags);
CIMGUI_API bool igArrowButtonEx(
	const char* str_id,
	ImGuiDir dir,
	ImVec2 size_arg,
	ImGuiButtonFlags flags);
...
CIMGUI_API void igSeparatorTextEx(
	ImGuiID id,
	const char* label,
	const char* label_end,
	float extra_width);
CIMGUI_API bool igCheckboxFlags_S64Ptr(
	const char* label,
	ImS64* flags,
	ImS64 flags_value);
CIMGUI_API bool igCheckboxFlags_U64Ptr(
	const char* label,
	ImU64* flags,
	ImU64 flags_value);
...
CIMGUI_API bool igScrollbarEx(
	...
	ImS64 contents_v,
	ImDrawFlags flags);
CIMGUI_API void igGetWindowScrollbarRect(
	ImRect* pOut,
	ImGuiWindow* window,
	ImGuiAxis axis);
...
CIMGUI_API bool igDataTypeApplyFromText(
	...
	void* p_data,
	const char* format);
CIMGUI_API int igDataTypeCompare(
	ImGuiDataType data_type,
	const void* arg_1,
	const void* arg_2);
CIMGUI_API bool igDataTypeClamp(
	ImGuiDataType data_type,
	void* p_data,
	const void* p_min,
	const void* p_max);
...
CIMGUI_API void igColorTooltip(
	const char* text,
	const float* col,
	ImGuiColorEditFlags flags);
CIMGUI_API void igColorEditOptionsPopup(
	const float* col,
	ImGuiColorEditFlags flags);
CIMGUI_API void igColorPickerOptionsPopup(
	const float* ref_col,
	ImGuiColorEditFlags flags);
...
CIMGUI_API void igErrorCheckEndFrameRecover(
	...
	void* user_data);
CIMGUI_API void igErrorCheckEndWindowRecover(
	ImGuiErrorLogCallback log_callback,
	void* user_data);
...
CIMGUI_API void igDebugNodeWindowsList(
	ImVector_ImGuiWindowPtr* windows,
	const char* label);
...
CIMGUI_API void igImFontAtlasBuildSetupFont(
	...
	float ascent,
	float descent);
CIMGUI_API void igImFontAtlasBuildPackCustomRects(
	ImFontAtlas* atlas,
...
// no appendfV
CIMGUI_API void ImGuiTextBuffer_appendf(
